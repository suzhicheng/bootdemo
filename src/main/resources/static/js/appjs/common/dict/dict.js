					...
					},
					{
						...
						formatter : function(value, row, index) {
							if(value=="province"){
								...
								return "区县";
							}else if(value=="courseClassifyOne"){
								return "一级分类";
							}else if(value=="courseClassifyTwo"){
								return "二级分类";
							}else if(value=="hotBusinessDistrict"){
								return "热门商区";
							}else if(value=="hotSearch"){
								return "热门搜索";
							}else if(value=="grade"){
								return "年级";
								...
								return "测试类型";
							}else if(value=="noteClassify"){
								return "笔记成果分类";
							}else if(value=="otherClassify"){
								return "其他成果分类";
							}
						}
					},
